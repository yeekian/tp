...
class ComponentListTest {
    ...
    void setup() {
        ...
        comp1 = new Component("Homework 1", 30, 0.1);
        comp2 = new Component("Homework 2", 30, 0.1);
        comp3 = new Component("Finals", 100, 0.5);
    }
    ...
    void addComponent_addDuplicateComponent_exceptionThrown() {
        componentList.addComponent(comp1);
        Component duplicateComp = new Component("Homework 1", 30, 0.1);
